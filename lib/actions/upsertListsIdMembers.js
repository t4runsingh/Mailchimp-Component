...
function processAction(msg, cfg) {
  ...
  const applicationUid = msg.metadata !== undefined && msg.metadata.applicationUid !== undefined
    ...
    if (recordUid) {
      ...
      const subscriber_hash = crypto.createHash('md5').update(recordUid.toLowerCase()).digest("hex")
      console.log('subscriber_hash:', subscriber_hash);
      callParams['parameters']['subscriber_hash'] = subscriber_hash;
    } else {
